...
<footer class="footer">
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#gogoSer").click(function () {
          $.ajax({
              method: "GET",
              url: "https://dapi.kakao.com/v2/search/web",
              data: { query: $("#searchDaum").val() }, 
              headers: { Authorization: "KakaoAK c108898f24addb0ca2ab0cb07dcb8977" }
          })
              .done(function (msg) { // 응답이 오면 처리를 하는 코드
                  console.log(msg);
              		$("#daumContent").append("<strong>"+msg.documents[0].title+"</strong><br>");
              		$("#daumContent").append("<strong>"+msg.documents[0].contents+"</strong><br>");
              		$("#daumContent").append("<strong>"+msg.documents[0].datetime+"</strong>");
              });
      });
    });
  </script>
